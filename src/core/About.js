                    ...
                    <div className="border rounded shadow">
                        <div className="card m-2 ">
                            ...
                            <div class="card-body m-0 p-0">
                                ...
                                created by Softwarica Student Aashish Rawal. It is the design to get place in the top 
                                tourism website in 
                        ...
                        <div className="card m-2 ">
                            ...
                            <div class="card-body m-0 p-0">
                                <ul className="list-group">
                                    <li className="list-group-item text-info h6 font-weight-bold">Aashish Rawal</li>
